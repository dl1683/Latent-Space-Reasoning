...
def test_lean_gpu_mixed_transfer_v8_task_preset_adds_spend_controller_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v8",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v9_task_preset_adds_counterexample_probe_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v9",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v10_task_preset_freezes_composite_gate_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v10",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v11_task_preset_freezes_probe_value_floor_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v11",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v12_task_preset_freezes_source_aware_lift_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v12",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v13_task_preset_freezes_denoise_phase_realization_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v13",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v14_task_preset_freezes_realization_value_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v14",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v15_task_preset_freezes_static_probe_disagreement_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v15",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v17_task_preset_freezes_source_preservation_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v17",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v18_task_preset_freezes_generated_repair_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v18",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v19_task_preset_freezes_live_hook_validation_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v19",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v20_task_preset_freezes_low_margin_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v20",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v21_task_preset_freezes_candidate_diversity_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v21",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v23_task_preset_freezes_asymmetric_filter_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v23",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v24_task_preset_freezes_history_guard_audit_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v24",
        limit_tasks=None,
    )
...
def test_lean_gpu_mixed_transfer_v25_task_preset_freezes_learned_selector_slice():
    args = Namespace(
        tasks="experiments/general_reasoning_tasks_scout.jsonl",
        families="planning",
        task_ids=None,
        task_preset="lean_gpu_mixed_transfer_v25",
        limit_tasks=None,
    )
...
def test_counterfactual_micro_probe_compact_policy_records_validity():
    task = GeneralReasoningTask(
        task_id="plan_probe",
        family="planning",
        prompt="Plan an audit that measures retained evidence before promoting repair.",
    ...
    backend = _FakeExactRepairBackend(
        [
            (
                "A=retained evidence measurement\n"
                "B=before after evidence table\n"
                "C=repair may delete audit context\n"
                "Z=false"
            )
        ]
    )
    ...
    probe_record = _generate_counterfactual_micro_probe_record(
        ...
        diagnostics=diagnostics,
        generation_seed_base=123,
        probe_policy="compact_tomography_probe_v3",
    )
    measured = _measured_counterfactual_micro_probe_diagnostics(
        probe_record,
        source_record=source,
...
def test_counterfactual_micro_probe_span_policy_records_validity():
    task = GeneralReasoningTask(
        task_id="plan_probe",
        family="planning",
        prompt="Plan an audit that measures retained evidence before promoting repair.",
    ...
    assert probe_record["counterfactual_probe"]["probe_policy"] == "span_tomography_probe_v4"
    assert probe_record["config"]["max_new_tokens"] == 48
    assert probe_record["config"]["steps"] == 24
    assert measured["counterfactual_probe_policy"] == "span_tomography_probe_v4"
    assert measured["counterfactual_probe_cost_relative"] == 0.1875
    assert "Weak task words:" in backend.prompts[0]
    assert "labels X0, X1, X2, N" in backend.prompts[0]
    assert "MISSING_CONSTRAINT=" not in backend.prompts[0]
    assert "N=0" in backend.prompts[0]
    assert measured["counterfactual_probe_text_slot_count"] == 3
    assert measured["counterfactual_probe_text_exact_authorization_false"] is True
    assert measured["counterfactual_probe_text_malformed_authorization"] is False
    assert measured["counterfactual_probe_text_valid_for_stage1"] is True
...
def test_counterfactual_micro_probe_text_validity_accepts_compact_schema():
    ...
    assert validity["exact_authorization_false"] is True
    assert validity["malformed_authorization"] is False
    assert validity["valid_for_stage1"] is True


def test_counterfactual_micro_probe_text_validity_accepts_span_schema():
    validity = _counterfactual_micro_probe_text_validity(
        "X0=retained evidence\n"
        "X1=Plan an audit\n"
        "X2=promoting repair\n"
...
def test_counterfactual_micro_probe_text_validity_rejects_span_generic_or_bad_sentinel():
    generic = _counterfactual_micro_probe_text_validity(
        "X0=unknown\n"
        "X1=Plan an audit\n"
        "X2=promoting repair\n"
        "N=0"
    )
    malformed = _counterfactual_micro_probe_text_validity(
        "X0=retained evidence\n"
        "X1=Plan an audit\n"
        "X2=promoting repair\n"
        "N=1"
    ...
    assert generic["slot_count"] == 3
    assert generic["generic_slot"] is True
    assert generic["valid_for_stage1"] is False
    assert malformed["slot_count"] == 3
    assert malformed["exact_authorization_false"] is False
    assert malformed["malformed_authorization"] is True
    assert malformed["valid_for_stage1"] is False


def test_counterfactual_micro_probe_text_validity_rejects_compact_generic_or_bad_sentinel():
    generic = _counterfactual_micro_probe_text_validity(
        "A=unknown\n"
        "B=before after evidence table\n"
        "C=repair may delete audit context\n"
