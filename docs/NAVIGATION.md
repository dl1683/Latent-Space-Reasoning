...
- For the v9 complement-packet source contract and current generation blocker: [LATENT_AGGREGATION_MULTI_ASPECT_V9_COMPLEMENT_SOURCE_CONTRACT.md](reports/diffusion/LATENT_AGGREGATION_MULTI_ASPECT_V9_COMPLEMENT_SOURCE_CONTRACT.md)
