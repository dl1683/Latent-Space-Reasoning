...
| [DIFFUSION_DENOISE_PHASE_REALIZATION_V13_COUNTEREXAMPLES.md](../DIFFUSION_DENOISE_PHASE_REALIZATION_V13_COUNTEREXAMPLES.md) | Counterexample map extracting the v13 realization-value decision core: `plan_099` positive, `plan_102` no-lift, `plan_104` missed positive, and broad-trigger false positives. |
| [DIFFUSION_REALIZATION_VALUE_V14_FREEZE.md](../DIFFUSION_REALIZATION_VALUE_V14_FREEZE.md) | Frozen v14 realization-value proof obligation over `plan_105`-`plan_112`, with probe-conditioned band and denoise-trigger replay controls before labels. |
| [DIFFUSION_REALIZATION_VALUE_V14_MEASUREMENT.md](../DIFFUSION_REALIZATION_VALUE_V14_MEASUREMENT.md) | Fresh v14 measurement boundary: the slice has source divergence, but the frozen realization-value target selects no rows before labels; `plan_109` and `plan_112` are probe-cap near misses. |
| [DIFFUSION_REALIZATION_VALUE_V14B_ADDENDUM.md](../DIFFUSION_REALIZATION_VALUE_V14B_ADDENDUM.md) | Pre-label v14b addendum: relaxes only the probe cap to `<=0.033`, selects `plan_109` and `plan_112` before labels, and keeps denoise-trigger replay controls required. |
| [DIFFUSION_REALIZATION_VALUE_V14B_REPLAY.md](../DIFFUSION_REALIZATION_VALUE_V14B_REPLAY.md) | Fresh v14b replay: after denoise-trigger joining, the addendum captures selected-repair positives `plan_109` and `plan_112` with zero selected-repair false positives or false negatives. |
| [DIFFUSION_REALIZATION_VALUE_V15_FREEZE.md](../DIFFUSION_REALIZATION_VALUE_V15_FREEZE.md) | Frozen v15 static-vs-probe disagreement proof obligation over `plan_113`-`plan_120`, designed to test whether the measured probe adds transfer value beyond static source/gap/coverage banding. |
| [DIFFUSION_REALIZATION_VALUE_V15_MEASUREMENT.md](../DIFFUSION_REALIZATION_VALUE_V15_MEASUREMENT.md) | Fresh v15 measurement boundary: `plan_120` is static-selected and probe-rejected before labels, so the frozen label pass is authorized but transfer remains unclaimed. |
| [DIFFUSION_REALIZATION_VALUE_V15_REPLAY.md](../DIFFUSION_REALIZATION_VALUE_V15_REPLAY.md) | Fresh v15 replay falsifier: the probe-conditioned surface false-negatives selected-repair positive `plan_120`, while static banding has zero selected-repair errors on this slice. |
| [DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V15.md](../DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V15.md) | V15 post-repair promotion target sheet: the generated repair candidate for `plan_118` has small positive lift but is rejected by the incumbent promotion margin. |
| [DIFFUSION_PROMOTION_MARGIN_V16_FREEZE.md](../DIFFUSION_PROMOTION_MARGIN_V16_FREEZE.md) | Frozen v16 promotion-margin proof obligation over `plan_121`-`plan_128`, designed to test low-margin candidate realization without counting source-only lift as promotion. |
| [DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V16.md](../DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V16.md) | Fresh v16 promotion boundary: no generated repair candidate beats the selected trajectory, while `plan_128` remains oracle-positive outside the generated-candidate target sheet. |
| [DIFFUSION_SOURCE_PRESERVATION_V17_FREEZE.md](../DIFFUSION_SOURCE_PRESERVATION_V17_FREEZE.md) | Frozen v17 source-preservation proof obligation over `plan_129`-`plan_136`, targeting rows where a source beats the selected trajectory but generated repair degrades it. |
| [DIFFUSION_SOURCE_PRESERVATION_TARGETS_V17.md](../DIFFUSION_SOURCE_PRESERVATION_TARGETS_V17.md) | Fresh v17 source-preservation target sheet: the frozen source-positive repair-degradation gate is inconclusive, while generated repair positives appear on `plan_129`, `plan_130`, and `plan_131`. |
| [DIFFUSION_GENERATED_REPAIR_V18_FREEZE.md](../DIFFUSION_GENERATED_REPAIR_V18_FREEZE.md) | Frozen v18 generated-repair proof obligation over `plan_137`-`plan_144`, testing whether the v17 generated repair positives repeat on a fresh slice before any live trigger change. |
| [DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V18.md](../DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V18.md) | Fresh v18 generated-repair boundary: generated repair positives repeat on `plan_137` and `plan_139`, with zero candidate-aware promotion errors. |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V1.md](../DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V1.md) | Runner-level `generated_repair_value_v1` hook: label-free no-generation replay selects v18 positives `plan_137` and `plan_139` while rejecting no-lift rows `plan_141` and `plan_144`. |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_FREEZE.md](../DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_FREEZE.md) | Frozen v19 live-hook validation over `plan_145`-`plan_152`, requiring a fresh run of `generated_repair_value_v1` before promotion language. |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_RESULT.md](../DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_RESULT.md) | Fresh v19 live-hook result: the selector captures substantial positives `plan_145`, `plan_149`, and `plan_152`, rejects no-lift `plan_150`, and leaves low-margin `plan_151` as bounded regret. |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_TARGETS.md](../DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_TARGETS.md) | V19 generated-repair target sheet separating generated-candidate positives from no-lift rows for the fresh hook-validation run. |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_CONTROL_REPLAY.md](../DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_CONTROL_REPLAY.md) | V19 control replay: permissive planning-quality repair selection matches aggregate utility but selects extra no-lift and tiny-lift rows, so the hook remains a local precision policy. |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_SELECTED_COST_AUDIT.md](../DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_SELECTED_COST_AUDIT.md) | Selected-repair cost audit showing that any positive selected-output cost favors the hook over the permissive control because the control selects two waste rows. |
...
| [DIFFUSION_CANDIDATE_DIVERSITY_V21_RESULT.md](../DIFFUSION_CANDIDATE_DIVERSITY_V21_RESULT.md) | Fresh v21 candidate-diversity result: availability improves with four positive repair candidates, but the widened pool fails the selector gate because `plan_161` and `plan_162` are selected waste. |
| [DIFFUSION_CANDIDATE_DIVERSITY_V21_TARGETS.md](../DIFFUSION_CANDIDATE_DIVERSITY_V21_TARGETS.md) | V21 generated-repair target sheet with 12 candidate rows, candidate-name split, and promotion-error accounting for the two-candidate pool. |
| [DIFFUSION_SOURCE_AWARE_SELECTOR_V22_FREEZE.md](../DIFFUSION_SOURCE_AWARE_SELECTOR_V22_FREEZE.md) | Frozen v22 source-aware selector proof obligation over `plan_169`-`plan_176`, using v21 positives and selected-waste rows to define a replay surface before implementation. |
| [DIFFUSION_SOURCE_AWARE_SELECTOR_V22_RESULT.md](../DIFFUSION_SOURCE_AWARE_SELECTOR_V22_RESULT.md) | Fresh v22 source-aware selector result: the replay surface removes selected waste but misses fresh positives, so it remains diagnostic rather than a runner hook. |
| [DIFFUSION_SOURCE_AWARE_SELECTOR_V22_TARGETS.md](../DIFFUSION_SOURCE_AWARE_SELECTOR_V22_TARGETS.md) | V22 generated-repair target sheet with 10 candidate rows, three positives, and unchanged-hook promotion-error accounting. |
| [DIFFUSION_ASYMMETRIC_FILTER_V23_FREEZE.md](../DIFFUSION_ASYMMETRIC_FILTER_V23_FREEZE.md) | Frozen v23 asymmetric filter proof obligation over `plan_177`-`plan_184`, preserving the history-prefix guard while lowering the final-preserve threshold before labels. |
| [DIFFUSION_ASYMMETRIC_FILTER_V23_RESULT.md](../DIFFUSION_ASYMMETRIC_FILTER_V23_RESULT.md) | Fresh v23 asymmetric filter result: the replay remains precision-clean but under-recalls positives versus the unchanged hook, so it remains diagnostic rather than a runner hook. |
| [DIFFUSION_ASYMMETRIC_FILTER_V23_TARGETS.md](../DIFFUSION_ASYMMETRIC_FILTER_V23_TARGETS.md) | V23 generated-repair target sheet with 14 candidate rows, seven positives, and duplicate-candidate promotion-error accounting. |
...
| [DIFFUSION_LEARNED_SELECTOR_V25_RESULT.md](../DIFFUSION_LEARNED_SELECTOR_V25_RESULT.md) | Fresh v25 learned-selector result: the learned zero-waste model misses `plan_194`, while the unchanged hook again selects every positive without waste. |
| [DIFFUSION_LEARNED_SELECTOR_V25_TARGETS.md](../DIFFUSION_LEARNED_SELECTOR_V25_TARGETS.md) | V25 generated-repair target sheet with six candidate rows, two positives, and duplicate candidate-row error accounting. |
