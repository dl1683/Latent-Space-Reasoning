...
## Program status (2026-08-30 — RESTARTED in THEORY-FIRST mode; audits #27–#48 adopted; PSQ-2 CLOSED; PSQ-3 design in final lock round; orientation document `docs/HANDOFF_2026_08_30.md`)
...
- **Exploratory d_4** (psq2_v3_d4): IN PROGRESS (DIAGNOSTIC ONLY per Codex direction review). d_4 measurement on v3 adapter at 75% accuracy. Result is sub-gate exploratory, not a scientific claim. Config: `psq2_v3_d4.json`.
