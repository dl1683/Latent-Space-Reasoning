...
## Program status (2026-08-31 — RESTARTED in THEORY-FIRST mode; audits #27–#49 adopted; PSQ-2 CLOSED; PSQ-3μ CLOSED NO_INTERFACE; PSQ-3α CLOSED NO_INTERFACE; orientation document `docs/HANDOFF_2026_08_30.md`)
...
- Runner: `experiments/run_psq3.py`. Config: `experiments/config/psq3_alpha.json`. Result: `experiments/results/psq3_alpha/result.json`. Adapter: `experiments/results/psq3_alpha/adapter_seed42/`. Ledger: `psq3_alpha_result`.
