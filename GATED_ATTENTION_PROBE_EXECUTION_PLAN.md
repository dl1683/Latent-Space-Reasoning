...
- primary Qwen3-Next model is not cached locally; select and record a current quantized artifact before starting the expensive run

## Model Cache

| Role | Model | Cached | Cache path |
|---|---|---:|---|
| `baseline` | `Qwen/Qwen3-4B` | `True` | `C:\Users\devan\.cache\huggingface\hub\models--Qwen--Qwen3-4B` |
| `mechanics` | `Qwen/Qwen3-0.6B` | `True` | `C:\Users\devan\.cache\huggingface\hub\models--Qwen--Qwen3-0.6B` |
| `primary_gated` | `Qwen/Qwen3-Next-80B-A3B-Instruct` | `False` | `C:\Users\devan\.cache\huggingface\hub\models--Qwen--Qwen3-Next-80B-A3B-Instruct` |
