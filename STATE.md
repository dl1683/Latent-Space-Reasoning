...
- **Round 36c** (same-architecture, explicitly quotient-trained learned positive control, scored by the unchanged exact reducer) is being registered and implemented by Codex — the next registered increment, before any longer/wider behaviour-only cell.
