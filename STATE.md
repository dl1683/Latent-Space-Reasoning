...
- **THEORY — round 41 DONE: bridge specification repaired (audit-#45 edits 1–10 applied); `native_bridge_v1` DRAFT preregistration in `theory/EXPERIMENTS.md` (NOT locked; 2,688 call units; 32-call mechanical smoke; constants bound: ε₀ 1e−5, k_B 2, k_E 4, δ = δ_move = δ_spec = 0.02, 90-min CPU ceiling). Pending lock-readiness audit #46; no runner, no lock row, no compute.**
