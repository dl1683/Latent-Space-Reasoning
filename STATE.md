...
## Current statement (2026-08-29, night; audits #27–#32 govern their constructions; Codex direction rounds 10/12/15/18/19 and governance amendment 8 govern allocation)
...
- NEXT (round 20, 2026-08-30): `oracle_actuator_rung0` — remove E; train only J on a fixed hashed 8-code centred-simplex codebook at the block-12 slot; gates above in the ledger row `direction_r20_rung0_design`; capped primary + uncapped replay diagnostic; then rung 0b (encoder on tag-token positions, z-separability ≥ 0.80 before any injection). Navigator deferred. Ratio 3:1 (warning); tomorrow's increment ≤ 80 nonblank lines.
