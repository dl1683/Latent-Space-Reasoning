...
- `site_oracle_v1` — REGISTERED FAIL — BLOCK-12 SLOT/PROMPT EIGHT-WAY BOUNDED CONTROL (2026-08-30; audit #35 pending; ledger `site_oracle_v1_result`): cross-fitted margin-gradient directions injected once at 0.25 of the slot residual selected the target tag ~36 tokens later in 0.26 of cases (fask 0.96 = cue prior; hesk 0.54; vorn 0.46; all other tags ≤ 0.08; per fold 0.23–0.28; cue and random-direction matching 0.12; completion ≥ 0.95; zero-hook = cue). Pre-declared consequence (round 21): this slot/prompt is closed for further actuator repair; pivot via direction dialogue (round 22).
- NEXT: audit #35 → Codex round 22 (pivot after the slot closure). Rung 0b and the navigator remain off until the dialogue rules.
