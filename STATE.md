...
## Current statement (2026-08-29, late evening; audits #27–#31 govern their constructions; Codex direction rounds 10/12/15 govern allocation)
...
- `necessity_navigator_v1` — built; ELIGIBLE (round 18) but NOT RUN-READY (audit #32): duplicated swap input, incomplete manifest binding, comparator excludes self, untrained controls on non-identical inputs, smoke provenance mismatch, ratio 2.43:1 strict; fix, then a direction dialogue before any run; no v2.
