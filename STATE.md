...
- `reachability_v1` — MEASURED (2026-08-30; audit #36 pending; ledger `reachability_v1_result`): NO SLOT-SPECIFIC GEOMETRY CONCLUSION — slot top-mode energy 0.64 / effective rank 2.28 vs position nulls 0.58–0.73 / 1.8–2.7 and permuted-tag-order prompt controls 0.41–0.56 / 2.7–3.3; finite-dose linearity cos 0.94–0.995; modes 2–3 realize 0.61 / 0.49 of mode 1.
- NEXT: audit #36 → write-up of the structured negative (round 22: A once, then D). Rung 0b, alternate positions, larger models, the navigator and any block-12 actuator stay off.
