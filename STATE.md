...
- `onewrite_recall_rung1` — STAIRCASE RUNG 1: REGISTERED FAIL, unanimous (audit pending): on training entities at zero delay, write 0.17/0.19/0.29 = counterfactual 0.17/0.19/0.27 = random 0.17/0.21/0.33 (cue 0.125, visible 1.0); this interface (16-d linear E/J at the block-12 slot) STOPS per round 19; no later rung tested.
