...
- **LAC-0: Learned Action Carrier (2026-09-01, Phase 3). DESIGNING.** Codex pivot postmortem ruling: program continues, frozen Qwen mining stops permanently. Typed neural machine: action writer sees command+legend only (no world values/answers); world writer sees world+place only; executor combines through named port. 8-place navigation worlds, 4 primitive moves (permutations), episode-independent relabeling. ≤1.5M params + matched untyped control, 3 seeds, 5000 steps × batch 128, CPU only, 3-hour wall. 8/16 two-move compositions held out. 6 gates: integrity/oracle, primitive specificity ≥95%, three-way F≥0.90 [lb 0.85], composition ≥85% [lb 75%], recipient dependence ≥90%, matched control. Verdicts: INVALID_CARRIER, NO_LEARNED_ACTION_INTERFACE, PORTABLE_NOT_COMPOSABLE (terminal), PORTABLE_ACTION_CARRIER_REGISTERED. Distance-from-claim: 0. Theory Section 14. Codex ruling: scratchpad/codex_qpc1_pivot.txt.
