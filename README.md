...
| [DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_MEASUREMENT.md](DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_MEASUREMENT.md) | Fresh v11 measurement boundary: the GPU probe pass completed, but all planning rows had zero source-vs-trajectory delta, so the source-divergent gate failed before labels |
| [DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_RANDOM_SOURCE_FREEZE.md](DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_RANDOM_SOURCE_FREEZE.md) | Frozen random-source addendum for v11: deliberately uses the stable random arm as repair/probe source after fixed-source measurement failed to create source divergence |
| [DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_RANDOM_SOURCE_MEASUREMENT.md](DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_RANDOM_SOURCE_MEASUREMENT.md) | Fresh random-source v11 measurement: source divergence appears on 5/8 planning rows, authorizing the predeclared label pass without changing the frozen value floor |
| [DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_RANDOM_SOURCE_REPLAY.md](DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_RANDOM_SOURCE_REPLAY.md) | Fresh random-source v11 replay falsifier: the frozen value floor selects 3 no-lift rows, misses the only selected-repair positive, and has negative utility after probe cost |
| [DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_COUNTEREXAMPLES.md](DIFFUSION_COUNTERFACTUAL_SPAN_PROBE_VALUE_FLOOR_V11_COUNTEREXAMPLES.md) | Source-aware v11 counterexample map: high probe value on negative-delta random sources is no-lift; the selected-repair positive is source-aligned and below the old floor; `plan_084` splits generation value from promotion realization |
| [DIFFUSION_SOURCE_AWARE_LIFT_DIRECTION_V12_FREEZE.md](DIFFUSION_SOURCE_AWARE_LIFT_DIRECTION_V12_FREEZE.md) | Frozen v12 source-aware lift-direction proof obligation: new `plan_089`-`plan_096` slice, random-source measurement/label commands, selected-vs-oracle realization split, and controls before any live spend trigger |
| [DIFFUSION_SOURCE_AWARE_LIFT_DIRECTION_V12_MEASUREMENT.md](DIFFUSION_SOURCE_AWARE_LIFT_DIRECTION_V12_MEASUREMENT.md) | Fresh v12 measurement boundary: random-source pass `diffusion-36cf5bcb4eacd64e` creates three negative source-delta rows, blocks high-probe disagreement rows, and selects only `plan_091` before labels |
| [DIFFUSION_SOURCE_AWARE_LIFT_DIRECTION_V12_REPLAY.md](DIFFUSION_SOURCE_AWARE_LIFT_DIRECTION_V12_REPLAY.md) | Fresh v12 replay falsifier: the frozen source-aware surface selects no-lift `plan_091`, misses selected-repair positive `plan_093`, and leaves oracle-positive selector miss `plan_094` |
| [DIFFUSION_DENOISE_PHASE_REALIZATION_V13_FREEZE.md](DIFFUSION_DENOISE_PHASE_REALIZATION_V13_FREEZE.md) | Frozen v13 denoise-phase realization proof obligation: new `plan_097`-`plan_104` slice, source-aligned skeleton/phase evidence, selected-vs-oracle replay, and controls before GPU labels |
| [DIFFUSION_DENOISE_PHASE_REALIZATION_V13_MEASUREMENT.md](DIFFUSION_DENOISE_PHASE_REALIZATION_V13_MEASUREMENT.md) | Fresh v13 measurement boundary: random-source pass `diffusion-8196af06c90923b1` creates source disagreement, shows skeleton-only is too broad, and selects `plan_099` plus `plan_102` before labels |
| [DIFFUSION_DENOISE_PHASE_REALIZATION_V13_REPLAY.md](DIFFUSION_DENOISE_PHASE_REALIZATION_V13_REPLAY.md) | Fresh v13 replay falsifier: the frozen realization surface captures positive `plan_099` but selects no-lift `plan_102`, misses selected-repair positive `plan_104`, and remains diagnostic-only |
| [DIFFUSION_DENOISE_PHASE_REALIZATION_V13_COUNTEREXAMPLES.md](DIFFUSION_DENOISE_PHASE_REALIZATION_V13_COUNTEREXAMPLES.md) | V13 realization-value counterexample map: broad denoise triggering preserves recall but admits no-lift rows, while the fitted realization-value band is diagnostic-only |
| [DIFFUSION_REALIZATION_VALUE_V14_FREEZE.md](DIFFUSION_REALIZATION_VALUE_V14_FREEZE.md) | Frozen v14 realization-value proof obligation: new `plan_105`-`plan_112` slice, probe-conditioned band, denoise-trigger join, and replay controls before any v14 GPU labels |
| [DIFFUSION_REALIZATION_VALUE_V14_MEASUREMENT.md](DIFFUSION_REALIZATION_VALUE_V14_MEASUREMENT.md) | Fresh v14 measurement boundary: source divergence appears, but the frozen probe cap makes the pre-label target empty, so labels are blocked for this measurement |
| [DIFFUSION_REALIZATION_VALUE_V14B_ADDENDUM.md](DIFFUSION_REALIZATION_VALUE_V14B_ADDENDUM.md) | Pre-label v14b addendum: relaxes only the probe cap to `<=0.033`, selects near misses `plan_109` and `plan_112`, and preserves label/replay gates before any transfer claim |
| [DIFFUSION_REALIZATION_VALUE_V14B_REPLAY.md](DIFFUSION_REALIZATION_VALUE_V14B_REPLAY.md) | Fresh v14b replay: the relaxed realization-value surface selects `plan_109` and `plan_112` with zero selected-repair errors, while broad denoise/source/skeleton controls admit no-lift rows |
| [DIFFUSION_REALIZATION_VALUE_V15_FREEZE.md](DIFFUSION_REALIZATION_VALUE_V15_FREEZE.md) | Frozen v15 static-vs-probe disagreement slice: new `plan_113`-`plan_120` tasks, predeclared static and probe-conditioned surfaces, and conclusive gates before measurement or labels |
| [DIFFUSION_REALIZATION_VALUE_V15_MEASUREMENT.md](DIFFUSION_REALIZATION_VALUE_V15_MEASUREMENT.md) | Fresh v15 measurement boundary: `plan_120` creates a static-only pre-label disagreement, authorizing the frozen label pass while leaving transfer unclaimed until replay |
| [DIFFUSION_REALIZATION_VALUE_V15_REPLAY.md](DIFFUSION_REALIZATION_VALUE_V15_REPLAY.md) | Fresh v15 replay falsifier: static banding captures positive `plan_120`, while the probe-conditioned surface misses it and remains diagnostic-only |
| [DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V15.md](DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V15.md) | V15 candidate-promotion target sheet: generated positives are `plan_118` and `plan_120`, but incumbent `candidate_aware_promotion_v1` misses low-margin `plan_118` |
| [DIFFUSION_PROMOTION_MARGIN_V16_FREEZE.md](DIFFUSION_PROMOTION_MARGIN_V16_FREEZE.md) | Frozen v16 promotion-margin proof obligation: new `plan_121`-`plan_128` slice tests whether low-margin candidate-realization features recover positives without source-relative traps |
| [DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V16.md](DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V16.md) | Fresh v16 promotion boundary: zero generated-positive repair candidates, so the margin-relaxation gate is inconclusive and the next issue is generation/source search |
| [DIFFUSION_SOURCE_PRESERVATION_V17_FREEZE.md](DIFFUSION_SOURCE_PRESERVATION_V17_FREEZE.md) | Frozen v17 source-preservation proof obligation: new `plan_129`-`plan_136` slice tests source-positive repair-degradation rows like `plan_128` before another margin selector change |
| [DIFFUSION_SOURCE_PRESERVATION_TARGETS_V17.md](DIFFUSION_SOURCE_PRESERVATION_TARGETS_V17.md) | Fresh v17 source-preservation target sheet: no source-positive repair-degradation rows appear, but generated repairs are positive on `plan_129`, `plan_130`, and `plan_131` |
| [DIFFUSION_GENERATED_REPAIR_V18_FREEZE.md](DIFFUSION_GENERATED_REPAIR_V18_FREEZE.md) | Frozen v18 generated-repair proof obligation: new `plan_137`-`plan_144` slice tests whether the v17 generated repair positives repeat before any live trigger change |
| [DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V18.md](DIFFUSION_CANDIDATE_PROMOTION_TARGETS_V18.md) | Fresh v18 generated-repair boundary: positives repeat on `plan_137` and `plan_139`, and `candidate_aware_promotion_v1` selects both without promotion errors |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V1.md](DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V1.md) | Runner-level `generated_repair_value_v1` hook: label-free no-generation replay reproduces the v18 positive and no-lift boundary before fresh live validation |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_FREEZE.md](DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_FREEZE.md) | Frozen v19 live-hook validation: new `plan_145`-`plan_152` slice runs `generated_repair_value_v1` before any controller-promotion language |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_RESULT.md](DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_RESULT.md) | Fresh v19 live-hook result: `generated_repair_value_v1` selects three substantial positives, rejects no-lift `plan_150`, misses tiny positive `plan_151`, and improves repair-covered score after cost |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_TARGETS.md](DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_TARGETS.md) | V19 generated-repair target sheet: four generated-positive repair candidates and one no-lift candidate from the fresh hook-validation run |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_CONTROL_REPLAY.md](DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_CONTROL_REPLAY.md) | V19 permissive-control replay: planning-quality zero-margin control matches hook aggregate utility but selects extra no-lift/tiny-lift rows, keeping promotion local |
| [DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_SELECTED_COST_AUDIT.md](DIFFUSION_GENERATED_REPAIR_VALUE_HOOK_V19_SELECTED_COST_AUDIT.md) | Selected-repair cost audit: explicit selected-output pricing makes `generated_repair_value_v1` dominate the permissive control for any positive selected-repair cost |
| [DIFFUSION_LOW_MARGIN_REPAIR_V20_FREEZE.md](DIFFUSION_LOW_MARGIN_REPAIR_V20_FREEZE.md) | Frozen v20 low-margin repair proof obligation: new `plan_153`-`plan_160` slice tests whether tiny source-tie positives like `plan_151` recur without admitting no-lift rows like `plan_150` |
| [DIFFUSION_LOW_MARGIN_REPAIR_V20_RESULT.md](DIFFUSION_LOW_MARGIN_REPAIR_V20_RESULT.md) | Fresh v20 low-margin result: zero generated repair positives, so the low-margin fallback is not validated and the main hook remains unchanged |
| [DIFFUSION_LOW_MARGIN_REPAIR_V20_TARGETS.md](DIFFUSION_LOW_MARGIN_REPAIR_V20_TARGETS.md) | V20 target sheet: four generated repair candidates, all negative versus selected trajectory |
| [DIFFUSION_CANDIDATE_DIVERSITY_V21_FREEZE.md](DIFFUSION_CANDIDATE_DIVERSITY_V21_FREEZE.md) | Frozen v21 candidate-diversity proof obligation: new `plan_161`-`plan_168` slice adds `history_prefix_25_repair` before the current final-preserve repair while keeping `generated_repair_value_v1` unchanged |
| [DIFFUSION_CANDIDATE_DIVERSITY_V21_RESULT.md](DIFFUSION_CANDIDATE_DIVERSITY_V21_RESULT.md) | Fresh v21 candidate-diversity result: broader availability creates four positive repair-candidate rows, but the unchanged hook also selects `plan_161`/`plan_162` waste rows, so live broadening is not validated |
| [DIFFUSION_CANDIDATE_DIVERSITY_V21_TARGETS.md](DIFFUSION_CANDIDATE_DIVERSITY_V21_TARGETS.md) | V21 target sheet: 12 generated repair candidates, four positives split across history-prefix and final-preserve repairs, and two promotion errors for the widened pool |
| [DIFFUSION_SOURCE_AWARE_SELECTOR_V22_FREEZE.md](DIFFUSION_SOURCE_AWARE_SELECTOR_V22_FREEZE.md) | Frozen v22 source-aware selector proof obligation: new `plan_169`-`plan_176` slice tests a replay-only candidate-source-aware surface before any runner hook change |
| [DIFFUSION_SOURCE_AWARE_SELECTOR_V22_RESULT.md](DIFFUSION_SOURCE_AWARE_SELECTOR_V22_RESULT.md) | Fresh v22 source-aware selector result: the frozen replay surface rejects selected waste but overfilters, selecting only `plan_175` and missing positives `plan_169`/`plan_170` |
| [DIFFUSION_SOURCE_AWARE_SELECTOR_V22_TARGETS.md](DIFFUSION_SOURCE_AWARE_SELECTOR_V22_TARGETS.md) | V22 target sheet: 10 generated repair candidates, three positives, and three promotion errors under the unchanged hook |
| [DIFFUSION_ASYMMETRIC_FILTER_V23_FREEZE.md](DIFFUSION_ASYMMETRIC_FILTER_V23_FREEZE.md) | Frozen v23 asymmetric filter proof obligation: new `plan_177`-`plan_184` slice keeps the history-prefix guard while relaxing final-preserve recall before labels |
| [DIFFUSION_ASYMMETRIC_FILTER_V23_RESULT.md](DIFFUSION_ASYMMETRIC_FILTER_V23_RESULT.md) | Fresh v23 asymmetric filter result: precision stays clean, but the replay selects only three positives while the unchanged hook selects six positives and zero waste, so the filter is not validated |
| [DIFFUSION_ASYMMETRIC_FILTER_V23_TARGETS.md](DIFFUSION_ASYMMETRIC_FILTER_V23_TARGETS.md) | V23 target sheet: 14 generated repair candidates, seven positive rows, and duplicate-candidate promotion-error accounting for the widened source pool |
| [DIFFUSION_HISTORY_GUARD_V24_FREEZE.md](DIFFUSION_HISTORY_GUARD_V24_FREEZE.md) | Frozen v24 history-prefix guard audit: new `plan_185`-`plan_192` slice treats the unchanged hook as baseline and forbids final-preserve filtering before fresh replay |
| [DIFFUSION_HISTORY_GUARD_V24_RESULT.md](DIFFUSION_HISTORY_GUARD_V24_RESULT.md) | Fresh v24 history guard result: unchanged hook selects all three generated positives with zero waste and beats blanket history/final controls, revalidating it as the live baseline |
| [DIFFUSION_HISTORY_GUARD_V24_TARGETS.md](DIFFUSION_HISTORY_GUARD_V24_TARGETS.md) | V24 target sheet: 10 generated repair candidates, three positives, and three duplicate candidate-row errors that are not selected-hook errors |
| [DIFFUSION_LEARNED_SELECTOR_V25_FREEZE.md](DIFFUSION_LEARNED_SELECTOR_V25_FREEZE.md) | Frozen v25 learned selector proof obligation: trains only on v21-v24 candidate-row counterexamples and tests on new `plan_193`-`plan_200` before any runner hook change |
| [DIFFUSION_LEARNED_SELECTOR_V25_RESULT.md](DIFFUSION_LEARNED_SELECTOR_V25_RESULT.md) | Fresh v25 learned-selector result: the zero-waste learned threshold misses `plan_194`, while the unchanged hook selects both positives with zero waste, so no runner hook changes |
| [DIFFUSION_LEARNED_SELECTOR_V25_TARGETS.md](DIFFUSION_LEARNED_SELECTOR_V25_TARGETS.md) | V25 target sheet: six generated repair candidates, two positives, and two duplicate candidate-row errors that are not selected-hook errors |
...
| [GATED_ATTENTION_ARTIFACT_DECISION.md](GATED_ATTENTION_ARTIFACT_DECISION.md) | Current Qwen3-Next artifact/runtime decision: full Transformers is soft-prefix compatible in principle but locally unsupported; GGUF Q4_K_M is serving-only until an embedding hook exists |
